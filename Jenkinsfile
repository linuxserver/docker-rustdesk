pipeline {
  ...
  environment {
    ...
    EXT_USER = 'rustdesk'
    EXT_REPO = 'rustdesk'
    BUILD_VERSION_ARG = 'RUSTDESK_VERSION'
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-rustdesk'
    CONTAINER_NAME = 'rustdesk'
    DOCKERHUB_IMAGE = 'linuxserver/rustdesk'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/rustdesk'
    PR_DOCKERHUB_IMAGE = 'lspipepr/rustdesk'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH = 'true'
    CI = 'true'
    CI_WEB = 'true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-rustdesk/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-rustdesk\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-rustdesk\" \
          ...
          --label \"org.opencontainers.image.description=[RustDesk](https://rustdesk.com/) is a full-featured open source remote control alternative for self-hosting and security with minimal configuration.\" \
